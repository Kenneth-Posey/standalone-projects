...
module Ore = 
    ...
    let RawOreYield (ore:OreType) :OreYield = 
        match ore with
        | Arkonor      ->  { BaseOreYield with Tritanium = Tritanium 22000
                                               Mexallon  = Mexallon  2500
                                               Megacyte  = Megacyte  320    }
        | Bistot       ->  { BaseOreYield with Pyerite   = Pyerite   12000  
                                               Megacyte  = Megacyte  100    
                                               Zydrine   = Zydrine   450    }
        | Crokite      ->  { BaseOreYield with Tritanium = Tritanium 21000  
                                               Nocxium   = Nocxium   760    
                                               Zydrine   = Zydrine   135    }
        | DarkOchre    ->  { BaseOreYield with Tritanium = Tritanium 10000   
                                               Isogen    = Isogen    1600
                                               Nocxium   = Nocxium   120    }
        | Gneiss       ->  { BaseOreYield with Pyerite   = Pyerite   2200   
                                               Mexallon  = Mexallon  2400   
                                               Isogen    = Isogen    300    }
        | Hedbergite   ->  { BaseOreYield with Pyerite   = Pyerite   1000  
                                               Isogen    = Isogen    200  
                                               Nocxium   = Nocxium   100 
                                               Zydrine   = Zydrine   19     }
        | Hemorphite   ->  { BaseOreYield with Tritanium = Tritanium 2200  
                                               Isogen    = Isogen    100
                                               Nocxium   = Nocxium   120 
                                               Zydrine   = Zydrine   15     }
        | Jaspet       ->  { BaseOreYield with Mexallon  = Mexallon  350 
                                               Nocxium   = Nocxium   75 
                                               Zydrine   = Zydrine   8      }
        | Kernite      ->  { BaseOreYield with Tritanium = Tritanium 134 
                                               Mexallon  = Mexallon  267 
                                               Isogen    = Isogen    134    }
        | Mercoxit     ->  { BaseOreYield with Morphite  = Morphite  300    }
        ...
        | Scordite     ->  { BaseOreYield with Tritanium = Tritanium 346 
                                               Pyerite   = Pyerite   173    }
        | Spodumain    ->  { BaseOreYield with Tritanium = Tritanium 56000
                                               Pyerite   = Pyerite   12050
                                               Mexallon  = Mexallon  2100
                                               Isogen    = Isogen    450    }
